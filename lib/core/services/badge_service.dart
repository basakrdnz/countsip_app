...
class BadgeService {
  static final List<Badge> allBadges = [
    ...
    Badge(
      ...
      nameEn: 'First Step',
      icon: '🎯',
      description: 'İlk içki kaydı (0 APS).',
    ...
    Badge(
      ...
      icon: '🌈',
      description: '5 farklı kategoride içki dene.',
    ...
    Badge(
      ...
      nameEn: 'Explorer',
      icon: '🗺️',
      description: '10 farklı içki türü dene.',
    ...
    Badge(
      ...
      nameEn: 'Experiencer',
      icon: '🎯',
      description: '25 farklı içki türü dene.',
    ...
    Badge(
      ...
      nameEn: 'Collector',
      icon: '🏆',
      description: '50 farklı içki türü dene.',
    ...
    Badge(
      ...
      nameEn: 'Connoisseur',
      icon: '💎',
      description: '100 farklı içki türü dene.',
